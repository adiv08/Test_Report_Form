    ...
    return (
      <form>
        <div>
          ...
          <input id="Test Report No" type="text" />
        </div>
        <div>
          <label>Issue Date:</label>
          <input id="Issue Date" type="text" />
        </div>
        <div>
    ...
    <tbody>
        ...
        <tr>
            <td width="173">
                ...
                <p align="center">
                <input id="Testing Engineer" type="text" />
                </p>
            </td>
            <td width="172">
                <p align="center">
            ...
            <td width="145">
                ...
                <p>
                <input id="Business Development Head" type="text" />
                </p>
            </td>
        </tr>
        <tr>
            <td width="173" valign="top">
                ...
                <p align="center">
                <input id="testingenggdate" type="text" />
                </p>
            </td>
        ...
        <label>REPORT REFRENCE NUMBER:</label>
          <input id="REPORT REFRENCE NUMBER" type="text" /> 
        </div>

        <div>
        <label>ULR NO. :</label>
          <input id="ULRN" type="text" /> 
        </div>

        <div>
        <label>DATE OF ISSUE :</label>
          <input id="DOISSUE" type="text" /> 
        </div>

        <div>
        <label>TOTAL NUMBER OF Pages:</label>
          <input id="topages" type="text" /> 
        </div>

        <div>
        <label>Manufacturer's Name:</label>
          <input id="Manufacturer's Name" type="text" /> 
        </div>
        ...
        <label>test item Description:</label>
          <input id="test item Description" type="text" /> 
        </div>
        ...
        <label>Model type Refrence:</label>
          <input id="Model type REFRENCE" type="text" /> 
        </div>
    ...
    <tbody>
        ...
        <tr>
            <td width="173">
                ...
                <p align="center">
                <input id="Testing Engineer2" type="text" />
                </p>
            </td>
            <td width="172">
                <p align="center">
            ...
            <td width="145">
                ...
                <p>
                <input id="Business Development Head2" type="text" />
                </p>
            </td>
        </tr>
        <tr>
            <td width="173" valign="top">
                ...
                <p align="center">
                <input id="testingenggdate2" type="text" />
                </p>
            </td>
            <td width="172" valign="top">
                <p align="center">
          ...
          <table border="1" cellspacing="0" cellpadding="0" width="726">
            <tbody>
              ...
              <tr>
                ...
                <td width="102" valign="top">
                <input id="cl.15 requriment" type="text" /> 
                </td>
                <td width="102" valign="top">
                <input id="cl.15 requriment passed" type="text" /> 
                </td>
                <td width="48" valign="top">
                <input id="cl.15 page no." type="text" /> 
                </td>
              </tr>
              <tr>
                <td width="90" valign="top">
                ...
                <td width="102" valign="top">
                <input id="cl.1.6 requriment" type="text" /> 
                </td>
                <td width="102" valign="top">
                <input id="cl.1.6 requriment passed" type="text" /> 
                </td>
                <td width="48" valign="top">
                <input id="cl.1.6 page no." type="text" /> 
                </td>
              </tr>
              <tr>
                <td width="90" valign="top">
                ...
                <td width="102" valign="top">
                <input id="cl.1.7 requriment" type="text" /> 
                </td>
                <td width="102" valign="top">
                <input id="cl.1.7 requriment passed" type="text" /> 
                </td>
                <td width="48" valign="top">
                <input id="cl.1.7 page no." type="text" /> 
                </td>
              </tr>
              <tr>
                <td width="90" valign="top">
                ...
                <td width="102" valign="top">
                <input id="cl.2.1 requriment" type="text" /> 
                </td>
                <td width="102" valign="top">
                <input id="cl.2.1 requriment passed" type="text" /> 
                </td>
                <td width="48" valign="top">
                <input id="cl.2.1 page no." type="text" /> 
                </td>
              </tr>
              <tr>
                <td width="90" valign="top">
                ...
                <td width="102" valign="top">
                <input id="cl.2.2 requriment" type="text" /> 
                </td>
                <td width="102" valign="top">
                <input id="cl.2.2 requriment passed" type="text" /> 
                </td>
                <td width="48" valign="top">
                <input id="cl.2.2 page no." type="text" /> 
                </td>
              </tr>
              <tr>
                <td width="90" valign="top">
                ...
                <td width="102" valign="top">
                <input id="cl.2.3 requriment" type="text" /> 
                </td>
                <td width="102" valign="top">
                <input id="cl.2.3 requriment passed" type="text" /> 
                </td>
                <td width="48" valign="top">
                <input id="cl.2.3 page no." type="text" /> 
                </td>
              </tr>
              <tr>
                <td width="90" valign="top">
                ...
                <td width="102" valign="top">
                <input id="cl.2.4 requriment" type="text" /> 
                </td>
                <td width="102" valign="top">
                <input id="cl.2.4 requriment passed" type="text" /> 
                </td>
                <td width="48" valign="top">
                <input id="cl.2.4 page no." type="text" /> 
                </td>
              </tr>
              <tr>
                <td width="90" valign="top">
                ...
                <td width="102" valign="top">
                <input id="cl.2.5 requriment" type="text" /> 
                </td>
                <td width="102" valign="top">
                <input id="cl.2.5 requriment passed" type="text" /> 
                </td>
                <td width="48" valign="top">
                <input id="cl.2.5 page no." type="text" /> 
                </td>
              </tr>
              <tr>
                <td width="90" valign="top">
                ...
                <td width="102" valign="top">
                <input id="cl.2.6 requriment" type="text" /> 
                </td>
                <td width="102" valign="top">
                <input id="cl.2.6 requriment passed" type="text" /> 
                </td>
                <td width="48" valign="top">
                <input id="cl.2.6 page no." type="text" /> 
                </td>
              </tr>
              <tr>
                <td width="90" valign="top">
                ...
                <td width="102" valign="top">
                <input id="cl.2.7 requriment" type="text" /> 
                </td>
                <td width="102" valign="top">
                <input id="cl.2.7 requriment passed" type="text" /> 
                </td>
                <td width="48" valign="top">
                <input id="cl.2.7 page no." type="text" /> 
                </td>
              </tr>
              <tr>
                <td width="90" valign="top">
                ...
                <td width="102" valign="top">
                <input id="cl.2.8 requriment" type="text" /> 
                </td>
                <td width="102" valign="top">
                <input id="cl.2.8 requriment passed" type="text" /> 
                </td>
                <td width="48" valign="top">
                <input id="cl.2.8 page no." type="text" /> 
                </td>
              </tr>
              <tr>
                <td width="90" valign="top">
                ...
                <td width="102" valign="top">
                <input id="cl.2.9 requriment" type="text" /> 
                </td>
                <td width="102" valign="top">
                <input id="cl.2.9 requriment passed" type="text" /> 
                </td>
                <td width="48" valign="top">
                <input id="cl.2.9 page no." type="text" /> 
                </td>
              </tr>
              <tr>
                <td width="90" valign="top">
                ...
                <td width="102" valign="top">
                <input id="cl.2.10 requriment" type="text" /> 
                </td>
                <td width="102" valign="top">
                <input id="cl.2.10 requriment passed" type="text" /> 
                </td>
                <td width="48" valign="top">
                <input id="cl.2.10 page no." type="text" /> 
                </td>
              </tr>
              <tr>
                <td width="90" valign="top">
                ...
                <td width="102" valign="top">
                <input id="cl.3.1 requriment" type="text" /> 
                </td>
                <td width="102" valign="top">
                <input id="cl.3.1 requriment passed" type="text" /> 
                </td>
                <td width="48" valign="top">
                <input id="cl.3.1 page no." type="text" /> 
                </td>
              </tr>
              <tr>
                <td width="90" valign="top">
                ...
                <td width="102" valign="top">
                <input id="cl.3.2 requriment" type="text" /> 
                </td>
                <td width="102" valign="top">
                <input id="cl.3.2 requriment passed" type="text" /> 
                </td>
                <td width="48" valign="top">
                <input id="cl.3.2 page no." type="text" /> 
                </td>
              </tr>
              <tr>
                <td width="90" valign="top">
                ...
                <td width="102" valign="top">
                <input id="cl.3.3 requriment" type="text" /> 
                </td>
                <td width="102" valign="top">
                <input id="cl.3.3 requriment passed" type="text" /> 
                </td>
                <td width="48" valign="top">
                <input id="cl.3.3 page no." type="text" /> 
                </td>
              </tr>
              <tr>
                <td width="90" valign="top">
                ...
                <td width="102" valign="top">
                <input id="cl.3.4 requriment" type="text" /> 
                </td>
                <td width="102" valign="top">
                <input id="cl.3.4 requriment passed" type="text" /> 
                </td>
                <td width="48" valign="top">
                <input id="cl.3.4 page no." type="text" /> 
                </td>
              </tr>
              <tr>
                <td width="90" valign="top">
                ...
                <td width="102" valign="top">
                <input id="cl.3.5 requriment" type="text" /> 
                </td>
                <td width="102" valign="top">
                <input id="cl.3.5 requriment passed" type="text" /> 
                </td>
                <td width="48" valign="top">
                <input id="cl.3.5 page no." type="text" /> 
                </td>
              </tr>
            </tbody>
          </table>
